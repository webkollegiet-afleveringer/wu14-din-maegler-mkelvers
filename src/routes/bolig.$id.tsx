      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
        <div className="mb-6 flex flex-col items-start justify-between border-b border-[#D3DEE8] pb-6 md:flex-row md:items-center">
          ...
          <div className="flex gap-8">
            <img src="/svgs/images.svg" alt="images" />
            <img src="/svgs/layers.svg" alt="layers" />
            <svg
              width="27"
              height="38"
              viewBox="0 0 27 38"
            ...
            >
              ...
              />
              <path
                d="M13.2964 17.3944C15.56 17.3944 17.3951 15.5593 17.3951 13.2957C17.3951 11.0321 15.56 9.19702 13.2964 9.19702C11.0328 9.19702 9.19775 11.0321 9.19775 13.2957C9.19775 15.5593 11.0328 17.3944 13.2964 17.3944Z"
                stroke="#7B7B7B"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 text-sm md:grid-cols-3">
          ...
          <table className="w-full">
            <tbody className="[&_tr:not(:first-child)_td]:pt-2">
              ...
              <tr>
                <td>Ejerudgifter:</td>
                <td className="text-right">Kr. {formatPrice(property.cost)}</td>
              </tr>
            </tbody>
          </table>
        </div>
